...
# Create a requirements.txt if it doesn't exist (boilerplate)
if [ ! -f "$REQUIREMENTS_FILE" ]; then
    echo "Creating default $REQUIREMENTS_FILE..."
    echo -e "picosdk\nnumpy\npandas\nmatplotlib" > "$REQUIREMENTS_FILE"
fi
...
if [ "$USE_VENV" = false ]; then
    ...
    # Check if the 'venv' module is actually installed (Ubuntu/Debian often strips this out)
